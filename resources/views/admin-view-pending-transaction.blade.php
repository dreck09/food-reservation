            ...
            @foreach($pending_list as $data)
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p id="total_payment">₱{{$data->total_payment}}.00</p>
                        <h5 class="mt-2 text-muted">Downpayment</h5>
                        <p id="downpayment">₱{{$data->downpayment}}.00</p>
                        </div>
                    </div>
                </div>  
                @endforeach  
                ...
                @csrf
                    ...
                    <div class="float-right mt-5 mb-3">
                        <a href="#" class="btn btn-sm btn-primary p-3">
                        Approved <i class="fas fa-arrow-right"></i></a>
                    </div>  
                </form> 
            @endforeach    
            </div>
